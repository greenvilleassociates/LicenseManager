...
create table systeminfo (globalid int primary key IDENTITY(1,1) NOT NULL, custid int, siteid int, ctsgridid int, mgmtip char(100), ip2 char(100),osbase char(50), sqlbase char(50), webbase char(50));
...
insert into systeminfo (custid, siteid, ctsgridid, mgmtip, ip2, osbase, sqlbase, webbase) VALUES (1, 1, 1, '10.44.44.252', '', 'Windows Server 2012R2', 'SQL2008EXP', 'IIS10');
